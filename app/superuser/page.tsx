    ...
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-[#f5f4f9] px-4 py-10 font-sans">
        <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 shadow-[0_4px_24px_rgba(60,52,137,0.08)] p-10">
          ...
          <div className="bg-amber-50 border-l-[3px] border-amber-400 rounded-r-lg px-4 py-3 text-[13px] text-amber-700 leading-relaxed mb-6 flex gap-2">
            ...
            This account will have full administrative access. Only authorised personnel should proceed.
          </div>
          ...
          <div className="flex flex-col gap-2 mb-5">
            ...
            <input
              type="email"
              placeholder="e.g. admin@kolcics.org"
              value={user.email}
